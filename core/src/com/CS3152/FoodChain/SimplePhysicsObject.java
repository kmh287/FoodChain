 ...
 * joints. It is the primary type of physics object. 
 *
 * This class does not provide Shape information, and cannot be instantiated directly.
 */
public abstract class SimplePhysicsObject extends PhysicsObject {
	 ...
	 */
	protected SimplePhysicsObject(TextureRegion texture) {
		this(texture,0,0);
	}
	 ...
	 * 
	 * @param texture   The object texture</param>
	 * @param x  Initial x position in world coordinates
	 * @param y  Initial y position in world coordinates
	 */
	protected SimplePhysicsObject(TextureRegion texture, float x, float y) {
		super(x,y);
		origin = new Vector2();
		setTexture(texture);
		body = null;
