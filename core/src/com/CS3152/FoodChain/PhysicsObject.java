 ...
 * to Box2d.  Box2d's separation of bodies and shapes (e.g. fixtures) can be a bit 
 * daunting. This class combines them together to simplify matters.
 *
